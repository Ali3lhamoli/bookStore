...
href="<?php echo $config['base_url']; ?>index.php?page=shop&page-nr=<?php echo $_GET['page-nr'] - 1 ?>">Previous</a>
       <?php } else { ?>
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark"
                                href="#">Previous</a>   <?php
                        }
                ...
                <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark d-f"
                href="<?php echo $config['base_url']; ?>index.php?page=shop&page-nr=<?php echo $counter ?>"><?php echo $counter ?></a></li>
<?php } ?>
 ...
 <a href="<?php echo $config['base_url']; ?>index.php?page=shop&page-nr=2" class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark">Next</a>
                    ...
                    if ($_GET['page-nr'] >= $pages) {
                           ?>
                         <span class="pagination__btn rounded-1"> 
                         <a href="#" class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark">Next</a>
                          ...
                          <?php
                               ...
                               <span> <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark"
                                    href="<?php echo $config['base_url']; ?>index.php?page=shop&page-nr=2&page-nr=<?php echo $_GET['page-nr'] + 1 ?>">Next</a></span>
                                <?php
