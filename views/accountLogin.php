...
<a href="<?= $config['base_url'];?>index.php?page=accountLogin" style="color:white;text-decoration: none;" >تسجيل دخول</a>
        </div>
        <div
          style="background-color: black;" class=" text-center fs-6 py-3 w-50">
          ...
          <div class="input-group rounded-1 mb-3">
            <input
              ...
              <?php if(isset($_SESSION['email'])): ?>
                value="<?= $_SESSION['email']?>" <?php endif ?>
